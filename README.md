...
▶️ **[전체 시연 영상 (3분)](docs/qa-gpt-demo-3min.webm)** · 📊 **[발표자료](docs/presentation.html)**

### 생성 산출물 (실제 출력)

업로드 한 번으로 아래 산출물이 실제로 생성됩니다.

| 📋 시정조치관리대장 (엑셀) | 📑 단계말 검토결과서 (HWPX) |
|:---:|:---:|
| ![시정조치서 표지](docs/images/output-excel-1.png) | ![검토결과서 표지](docs/images/output-report-1.png) |
| ![시정조치 상세](docs/images/output-excel-2.png) | ![검토결과 요약](docs/images/output-report-2.png) |
